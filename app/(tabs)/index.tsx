...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: FontSizes.sm, fontWeight: '600', color: Colors.midGray },
  tabTextActive: { color: Colors.primary },

  list: { padding: Spacing.md, paddingBottom: 32 },
  countLabel: { fontSize: FontSizes.xs, color: Colors.textMuted, marginBottom: Spacing.sm, fontWeight: '600' },
  ...
  userAvatarText: { fontSize: FontSizes.lg, fontWeight: '800', color: Colors.primary },
  ...
  roleBtnText: { fontSize: FontSizes.sm, fontWeight: '600', color: Colors.midGray },
